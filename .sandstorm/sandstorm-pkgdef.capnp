...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "a02ma6gv4c0fawzvdqh05wfpqagj5z26hzgz8fetxszqxwg15jh0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "myMPD"),

    appVersion = 0,  # Increment this for every release.

    appMarketingVersion = (defaultText = "10.3.3"),
    # Human-readable representation of appVersion. Should match the way you
    # identify versions of your app in documentation and marketing.

    actions = [
      # Define your "new document" handlers here.
      ( nounPhrase = (defaultText = "player"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://jcorporation.github.io/myMPD/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/jcorporation/myMPD",
      ...
      shortDescription = (defaultText = "MPD client"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  environ = [
    ...
    (key = "MYMPD_SSL", value = "false"),
    (key = "MYMPD_HTTP_PORT", value = "8000"),
  ]
);
